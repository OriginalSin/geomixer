...
links.Timeline.StepDate.prototype.getLabelMinor = function (date) {
    var MONTHS_SHORT = links.Timeline.months_short[links.Timeline.defaultLanguage];
    var DAYS_SHORT = links.Timeline.days_short[links.Timeline.defaultLanguage];
...
links.Timeline.StepDate.prototype.getLabelMajor = function (date) {
    var MONTHS = links.Timeline.months_full[links.Timeline.defaultLanguage];
    var DAYS = links.Timeline.days_full[links.Timeline.defaultLanguage];
