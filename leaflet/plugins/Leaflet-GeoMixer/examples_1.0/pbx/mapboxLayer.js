...
function Pbf(t) {
    this.buf = ArrayBuffer.isView(t) ? t : new Uint8Array(t || 0),
    this.pos = 0,
    this.type = 0,
...
function writeBigVarint(t, e) {
    ...
    i = t / 4294967296 | 0) : (r = ~(-t % 4294967296),
    i = ~(-t / 4294967296),
    4294967295 ^ r ? r = r + 1 | 0 : (r = 0,
    i = i + 1 | 0)),
...
function readUtf8(t, e, r) {
    for (var i = "", n = e; n < r; ) {
        ...
        if (n + s > r)
            break;
        var u, c, h;
        1 === s ? o < 128 && (a = o) : 2 === s ? (u = t[n + 1],
        128 === (192 & u) && (a = (31 & o) << 6 | 63 & u,
        a <= 127 && (a = null))) : 3 === s ? (u = t[n + 1],
        c = t[n + 2],
        128 === (192 & u) && 128 === (192 & c) && (a = (15 & o) << 12 | (63 & u) << 6 | 63 & c,
        (a <= 2047 || a >= 55296 && a <= 57343) && (a = null))) : 4 === s && (u = t[n + 1],
        c = t[n + 2],
        h = t[n + 3],
        128 === (192 & u) && 128 === (192 & c) && 128 === (192 & h) && (a = (15 & o) << 18 | (63 & u) << 12 | (63 & c) << 6 | 63 & h,
...
function VectorTileFeature$2(t, e, r, i, n) {
    ...
    this._keys = i,
    this._values = n,
    t.readFields(readFeature, this, e)
}
...
var read = function(t, e, r, i, n) {
    var o, a, s = 8 * n - i - 1, u = (1 << s) - 1, c = u >> 1, h = -7, l = r ? n - 1 : 0, f = r ? -1 : 1, p = t[e + l];
    for (l += f,
    o = p & (1 << -h) - 1,
    p >>= -h,
    h += s; h > 0; o = 256 * o + t[e + l],
    l += f,
    h -= 8)
        ;
    for (a = o & (1 << -h) - 1,
    o >>= -h,
    h += i; h > 0; a = 256 * a + t[e + l],
    l += f,
    h -= 8)
        ;
    if (0 === o)
  ...
  , write = function(t, e, r, i, n, o) {
    var a, s, u, c = 8 * o - n - 1, h = (1 << c) - 1, l = h >> 1, f = 23 === n ? Math.pow(2, -24) - Math.pow(2, -77) : 0, p = i ? 0 : o - 1, d = i ? 1 : -1, y = e < 0 || 0 === e && 1 / e < 0 ? 1 : 0;
    for (e = Math.abs(e),
    isNaN(e) || e === 1 / 0 ? (s = isNaN(e) ? 1 : 0,
    a = h) : (a = Math.floor(Math.log(e) / Math.LN2),
    e * (u = Math.pow(2, -a)) < 1 && (a--,
    u *= 2),
    e += a + l >= 1 ? f / u : f * Math.pow(2, 1 - l),
    e * u >= 2 && (a++,
    u /= 2),
    a + l >= h ? (s = 0,
    a = h) : a + l >= 1 ? (s = (e * u - 1) * Math.pow(2, n),
    a += l) : (s = e * Math.pow(2, l - 1) * Math.pow(2, n),
    a = 0)); n >= 8; t[r + p] = 255 & s,
    p += d,
    s /= 256,
    n -= 8)
...
Pbf.prototype = {
    ...
    writeFixed64: function(t) {
        this.realloc(8),
        writeInt32(this.buf, t & -1, this.pos),
        writeInt32(this.buf, Math.floor(t * SHIFT_RIGHT_32), this.pos + 4),
        this.pos += 8
    },
    ...
    writeVarint: function(t) {
        return t = +t || 0,
        t > 268435455 || t < 0 ? void writeBigVarint(t, this) : (this.realloc(4),
    ...
    writeRawMessage: function(t, e) {
        ...
        t(e, this);
        var i = this.pos - r;
        i >= 128 && makeRoomForExtraLength(r, i, this),
        this.pos = r - 1,
        this.writeVarint(i),
        this.pos += i
    },
...
VectorTileFeature$2.prototype.toGeoJSON = function(t, e, r) {
    ...
    var n, o, a = this.extent * Math.pow(2, r), s = this.extent * t, u = this.extent * e, c = this.loadGeometry(), h = VectorTileFeature$2.types[this.type];
    switch (this.type) {
    case 1:
        var l = [];
    ...
    case 2:
        ...
        break;
    case 3:
        for (c = classifyRings(c),
        n = 0; n < c.length; n++)
            for (o = 0; o < c[n].length; o++)
                i(c[n][o])
    }
...
L.SVG.Tile = L.SVG.extend({
    initialize: function(t, e, r) {
        L.SVG.prototype.initialize.call(this, r),
        this._tileCoord = t,
        this._size = e,
        this._initContainer(),
        ...
        r.interactive && (this._container.style.pointerEvents = "auto"),
        this._layers = {}
    },
    getCoord: function() {
    ...
    _updateIcon: function(t) {
        ...
        e.setAttribute("width", n.x + "px"),
        e.setAttribute("height", n.y + "px"),
        e.setAttribute("href", i.iconUrl)
    }
}),
...
L.VectorGrid = L.GridLayer.extend({
    ...
    createTile: function(t, e) {
        ...
        return r && (this._vectorTiles[this._tileCoordsToKey(t)] = n,
        n._features = {}),
        o.then(function(i) {
            for (var o in i.layers) {
                ...
                for (var c in a.features) {
                    var h, l = a.features[c], f = u;
                    if (r) {
                        h = this.options.getFeatureId(l);
                        var p = this._overriddenStyles[h];
                        p && (f = p[o] ? p[o] : p)
                    }
                    if (f instanceof Function && (f = f(l.properties, t.z)),
                    ...
                    f.length) {
                        ...
                        this.options.interactive && d.makeInteractive(),
                        r && (n._features[h] = {
                            layerName: o,
                            feature: d
                        })
            ...
            null != this._map && n.addTo(this._map),
    ...
    setFeatureStyle: function(t, e) {
        ...
        for (var r in this._vectorTiles) {
            ...
            if (o) {
                ...
                s = s instanceof Function ? s(a.properties, i.getCoord().z) : s,
                this._updateStyles(a, i, s)
            } else
                this._overriddenStyles[t] = e
        }
    },
...
var FeatureLayer = L.Class.extend({
    ...
    _getPixelBounds: function() {
        for (var t = this._parts, e = L.bounds([]), r = 0; r < t.length; r++)
            for (var i = t[r], n = 0; n < i.length; n++)
                e.extend(i[n]);
        var o = this._clickTolerance()
          , a = new L.Point(o,o);
        return e.min._subtract(a),
        e.max._add(a),
        e
    },
  ...
  , PointLayer = L.CircleMarker.extend({
    ...
    render: function(t, e) {
        FeatureLayer.prototype.render.call(this, t, e),
    ...
    updateStyle: function(t, e) {
        ...
        this._updateBounds(),
        FeatureLayer.prototype.updateStyle.call(this, t, e)
    },
  ...
  , polyBase = {
    _makeFeatureParts: function(t, e) {
        ...
        for (var n in i) {
            ...
            for (var s in o)
                r = o[s],
                "x"in r ? a.push(L.point(r.x * e, r.y * e)) : a.push(L.point(r[0] * e, r[1] * e));
            this._parts.push(a)
        }
    },
    makeInteractive: function() {
        ...
        var e = this
          , r = new Promise(function(r) {
            e._worker.addEventListener("message", function i(n) {
                n.data.coords && n.data.coords.x === t.x && n.data.coords.y === t.y && n.data.coords.z === t.z && (r(n.data),
...
L.Canvas.Tile = L.Canvas.extend({
    initialize: function(t, e, r) {
        L.Canvas.prototype.initialize.call(this, r),
        this._tileCoord = t,
        this._size = e,
        this._initContainer(),
        this._container.setAttribute("width", this._size.x),
    ...
    _onClick: function(t) {
        var e, r = this._map.mouseEventToLayerPoint(t).subtract(this.getOffset()), i = [];
        for (var n in this._layers)
            e = this._layers[n],
            e.options.interactive && e._containsPoint(r) && !this._map._draggableMoved(e) && (L.DomEvent._fakeStop(t),
            i.push(e));
